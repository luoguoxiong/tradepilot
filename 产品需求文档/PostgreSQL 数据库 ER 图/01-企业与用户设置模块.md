...
| 版本 | v0.3（2026-09-05，澄清多企业归属=维持一邮箱单企业（org_membership 列多租户专项）；org 三默认值列确认为 16 v0.4 区域与本地化口径，无 DDL 变更）<br>v0.2（2026-09-05，org 新增 `send_rules` 配置列（发送时间窗/频控），见 07 §7 与 16 FR-12）<br>v0.1（2026-09-04） |
