...
CREATE TYPE activity_type     AS ENUM ('stage_change','email','quote','follow_up','note','ai_action');
...
CREATE TYPE approval_status AS ENUM ('pending','approved','edited_approved','rejected');
