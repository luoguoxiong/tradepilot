...
| 版本 | v0.4（2026-09-05，`retry_of` 说明扩展为重试/重新生成共用溯源链（LangGraph v0.5 §9.4），无 DDL 变更）<br>v0.3（2026-09-05，任务并发排队与定时触发口径澄清（14 §7），见 §2.3/§4，无 DDL 变更）<br>v0.2（2026-09-05，对齐需求 02 v0.3 / 接口文档 02 v0.2：SOP 副本派生 / KPI metric 枚举）<br>v0.1（2026-09-04） |
